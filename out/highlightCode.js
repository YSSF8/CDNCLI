...
exports.highlightScriptTag = highlightScriptTag;
const Colors = {
    Reset: "\x1b[0m",
    FgRed: "\x1b[31m",
    FgGreen: "\x1b[32m",
 ...
 */
function highlightScriptTag(scriptTag) {
    ...
    const highlightedAttributes = attributes.replace(/(\S+)=("([^"]*)"|'([^']*)')|(\S+)/g, (_, keyWithValue, __, value1, value2, booleanAttr) => {
        if (keyWithValue) {
